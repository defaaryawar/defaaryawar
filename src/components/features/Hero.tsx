...
import { FaGithub, FaEnvelope, FaMapMarkerAlt, FaLinkedin, FaWhatsapp, FaCode, FaNetworkWired, FaServer, FaFileAlt, FaTools } from 'react-icons/fa';
...
const Hero: React.FC = () => {
    ...
    const translations = {
        ...
        tagline: language === 'en'
            ? personalInfo.tagline || `${personalInfo.title} passionate about creating impactful digital experiences`
            : personalInfo.taglineId || personalInfo.tagline || `${personalInfo.title} yang bersemangat dalam menciptakan pengalaman digital yang berdampak`,
    ...
    const bioText = typeof translations.bio === 'string'
        ? translations.bio
                ...
                <div className="mt-4 sm:mt-5 pt-3 border-t border-gray-200 dark:border-gray-700/50">
                    ...
                    <div className="mb-3">
                        <div className="flex items-center justify-center mb-2">
                            ...
                            <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{translations.programming}</span>
                        </div>
                        <div className="flex flex-wrap justify-center gap-2">
                            {personalInfo.skillCategories?.programming.map((skill, index) => (
                                ...
                                >
                                    <img src={skill.logo} alt={skill.name} className="w-3 h-3 mr-1.5" />
                                    <span className="text-xs text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">{skill.name}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        ...
                        <div>
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{translations.networking}</span>
                            </div>
                        ...
                        <div>
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{translations.deployment}</span>
                            </div>
                            <div className="flex flex-wrap justify-center gap-1.5">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{translations.office}</span>
                            </div>
                            <div className="flex flex-wrap justify-center gap-1.5">
                    ...
                    {/* Other Skills at the bottom */}
                    <div className="mt-3">
                        <div className="flex items-center justify-center mb-2">
                            <FaTools className="text-blue-500 dark:text-blue-400 mr-1" size={12} />
                            <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{translations.other}</span>
                        </div>
                        <div className="flex flex-wrap justify-center gap-1.5">
